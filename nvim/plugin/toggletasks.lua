if vim.g.did_load_toggletasks_plugin then
  return
end
vim.g.did_load_toggletasks_plugin = true
...
vim.keymap.set('n', '<leader>cs', '<cmd>Telescope toggletasks spawn<cr>', { silent = true, desc = 'spawn' })
vim.keymap.set('n', '<leader>cS', '<cmd>Telescope toggletasks select<cr>', { silent = true, desc = 'select' })
vim.keymap.set('n', '<leader>ce', '<cmd>Telescope toggletasks edit<cr>', { silent = true, desc = 'edit' })
